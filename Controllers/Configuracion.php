...
class Configuracion extends Controller
{
    ...
    public function admin()
    {
        ...
        $data['sexo'] = $this->model->selectDatos('sexo');
        $data['Cargo'] = $this->model->selectDatos('Cargo');
        $data['TIPODOCUMENTO'] = $this->model->selectDatos('TIPODOCUMENTO');
        $data['PRODUCTO'] = $this->model->selectDatos('PRODUCTO');
